...
- Keep three native white-background themes: existing baseline, spacious reading and compact technical document. Test the same Markdown headings, code, lists, tables and images across themes. Retain external design provenance without copying incompatible licensed CSS or claiming a theme-level popularity ranking.
