...
Body-image caption acceptance: figure/figcaption preserves supplied text and image references; caption font is body minus 2 CSS px, #999999, below the centered image. Verify all three themes. Ordinary following paragraphs and alt text are not silently promoted to captions.
